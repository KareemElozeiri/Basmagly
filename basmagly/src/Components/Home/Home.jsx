        ...
        <div style={{width: isOpen ? "250px" : "50px"}} className="sidebar">
            ...
            </div>
            {
                menuItem.map((item, index)=>(
                    ...
                    <NavLink to={item.path} key={index} className="link" activeclassName="active_section">
            ...
            <div className="navbar">
                ...
                <div className="user-menu" onClick={toggleDropdown}>
                    <div className="user-photo">
                        <img src="/images/default-avatar-profile-icon-of-social-media-user-vector.jpg" alt="User" />
                    </div>
